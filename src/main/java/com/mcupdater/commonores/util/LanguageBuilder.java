...
public class LanguageBuilder {
	...
	public static String buildTranslatedNames() {
		...
		for (int i = 0; i < CommonOres.types.size(); i++) {
			generated.append("tile.blockOre.").append(CommonOres.types.get(i)).append(".name=").append(CommonOres.types.get(i)).append(" ").append(ore).append("\n");
			generated.append("item.ingot." + CommonOres.types.get(i) + ".name=" + CommonOres.types.get(i) + " " + ingot + "\n");
			generated.append("item.dust." + CommonOres.types.get(i) + ".name=" + CommonOres.types.get(i) + " " + dust + "\n");
		}
